...
token_verifier_instance = IntrospectionTokenVerifier(
    introspection_endpoint=f"{AUTH_SERVER_URL}/introspect",
    server_url=RESOURCE_SERVER_URL,
    validate_resource=False,  # Don't validate resource for this example
)
...
def create_resource_server(
    ...
    token_verifier_instance: IntrospectionTokenVerifier = token_verifier_instance,
):
    ...
    resource_server = FastMCP(
        ...
        auth=auth_settings,
        token_verifier=token_verifier_instance,
    )
    ...
    async def test_endpoint(
        ...
        return {
            "message": message,
            "server": "Transparent OAuth Proxy Resource Server",
            "status": "active",
...
def main():
    ...
    resource_server = create_resource_server(
        ...
        token_verifier_instance=token_verifier_instance,
    )
