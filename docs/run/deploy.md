...
## Before anything else: the Host allowlist {#before-anything-else-the-host-allowlist}
...
## Workers, and who has to be sticky {#workers-and-who-has-to-be-sticky}
...
## `requestState` across workers {#requeststate-across-workers}
...
## Change notifications across replicas {#change-notifications-across-replicas}
...
## What the SDK does not give you {#what-the-sdk-does-not-give-you}
