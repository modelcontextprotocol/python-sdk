...
class Result(MCPModel):
    ...
    SDK injects/strips this at the wire boundary; handlers normally never set it.
    """
...
class CreateMessageRequestParams(RequestParams):
    ...
    Sent/received on sessions negotiating 2025-11-25 only; removed in protocol
    2026-07-28 (2026-07-28 receivers MUST ignore it, and the SDK strips it when
    emitting to 2026-07-28 peers).
    """
