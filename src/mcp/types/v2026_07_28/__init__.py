...
@ 6d441518de8a9d5adbab0b10a76a667a63f90665. Do not edit; regenerate. Schema-exact validators that the
...
class ElicitResult(WireModel):
    ...
    """
    # schema.json renders this `number` as integer; widen per schema.ts so floats validate.
