...
2. Create a Server instance with handlers:
   server = Server(
       "your_server_name",
       handlers=[
           RequestHandler("tools/list", handler=my_list_tools),
           RequestHandler("tools/call", handler=my_call_tool),
       ],
   )
...
RequestHandler and NotificationHandler objects by method string.
"""
