...
def _validate_rendered_properties(json_schema: dict[str, Any]) -> None:
    ...
    """
    # The gate's source of truth is the internal surface package; imported here on purpose,
    # not at module top: the generated package is heavy and only elicitation needs it.
