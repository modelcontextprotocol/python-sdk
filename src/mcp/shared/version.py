...
2026-07-28 is known but unreleased — its schema is published but still
subject to change — so it stays out of SUPPORTED_PROTOCOL_VERSIONS and ahead
of LATEST_PROTOCOL_VERSION until the specification releases it.
"""
