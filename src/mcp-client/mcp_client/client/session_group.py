...
from mcp_client.client.sse import sse_client
...
from mcp_client.shared._httpx_utils import create_mcp_http_client
from mcp_client.shared.dispatcher import ProgressFnT
from mcp_client.shared.exceptions import MCPError
...
class ClientSessionGroup:
    ...
    async def connect_with_session(self, server_info: types.Implementation, session: ClientSession) -> ClientSession:
