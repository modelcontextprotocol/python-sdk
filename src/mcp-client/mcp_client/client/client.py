...
from mcp_client.client.caching import CacheConfig, CacheMode, ClientResponseCache, InMemoryResponseCacheStore
from mcp_client.client.extension import ClaimContext, ClientExtension, NotificationBinding, ResultClaim
...
class Client:
    ...
    server: _InProcessServer | Transport | StdioServerParameters | str
    ...
    ad-only entry use `mcp_client.client.advertise(identifier, settings)`."""
