...
class TestFileResource:
    ...
    def test_file_resource_creation(self, temp_file: Path) -> None:
    ...
    def test_file_resource_str_path_conversion(self, temp_file: Path) -> None:
    ...
    @pytest.mark.anyio
    async def test_read_binary_file(self, temp_file: Path) -> None:
    ...
    def test_relative_path_error(self) -> None:
    ...
    @pytest.mark.anyio
    async def test_missing_file_error(self, temp_file: Path) -> None:
    ...
    @pytest.mark.anyio
    async def test_permission_error(self, temp_file: Path) -> None:  # pragma: lax no cover
