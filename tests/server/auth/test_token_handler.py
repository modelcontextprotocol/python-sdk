...
def mock_request() -> Callable[..., Request]:
    ...
    def _create_request(
        *, method: str = "POST", headers: dict[str, str] | None = None, form_data: dict[str, str] | None = None
    ) -> Request:
        scope: Scope = {
            "type": "http",
            "method": method,
        ...
        async def mock_form(
            *, max_files: int | float = 1000, max_fields: int | float = 1000, max_part_size: int = 1024 * 1024
        ) -> dict[str, str]:
            return form_data or {}
...
class TestTokenHandler:
    ...
    async def test_handle_with_form_data_credentials(
        self, token_handler: TokenHandler, mock_request: Callable[..., Request]
    ) -> None:
