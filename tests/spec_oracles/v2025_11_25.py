...
# Source: https://github.com/modelcontextprotocol/modelcontextprotocol/blob/6d441518de8a9d5adbab0b10a76a667a63f90665/schema/2025-11-25/schema.json
# Protocol version: 2025-11-25   Generator: datamodel-code-generator 0.57.0
# Regenerate: uv run --frozen python scripts/update_spec_types.py 2025-11-25 [--sha <new-sha>]
...
class Elicitation1(OracleModel):
...
class GetTaskPayloadResult(OracleModel):
...
class RelatedTaskMetadata(OracleModel):
...
class SetLevelRequestParams(OracleModel):
...
class SubscribeRequestParams(OracleModel):
...
class TaskMetadata(OracleModel):
...
class ToolExecution(OracleModel):
...
class UnsubscribeRequestParams(OracleModel):
...
class GetTaskPayloadRequest(OracleModel):
...
class InitializeRequestParams(OracleModel):
...
class TaskAugmentedRequestParams(OracleModel):
...
class URLElicitationRequiredError(OracleModel):
...
class ListTasksRequest(OracleModel):
...
class ListTasksResult(OracleModel):
