...
async def test_scenario1_normal_tool_normal_elicitation() -> None:
    ...
    async def on_call_tool(ctx: ServerRequestContext[Any], params: CallToolRequestParams) -> CallToolResult:
...
async def test_scenario3_task_augmented_tool_normal_elicitation() -> None:
    ...
    async def on_call_tool(ctx: ServerRequestContext[Any], params: CallToolRequestParams) -> CreateTaskResult:
