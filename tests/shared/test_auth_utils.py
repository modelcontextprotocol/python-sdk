...
def test_resource_url_from_server_url_removes_fragment() -> None:
...
def test_resource_url_from_server_url_preserves_path() -> None:
...
def test_resource_url_from_server_url_preserves_query() -> None:
...
def test_resource_url_from_server_url_preserves_port() -> None:
...
def test_resource_url_from_server_url_lowercase_scheme_and_host() -> None:
...
def test_resource_url_from_server_url_handles_pydantic_urls() -> None:
...
def test_check_resource_allowed_identical_urls() -> None:
...
def test_check_resource_allowed_different_schemes() -> None:
...
def test_check_resource_allowed_different_domains() -> None:
...
def test_check_resource_allowed_different_ports() -> None:
...
def test_check_resource_allowed_hierarchical_matching() -> None:
...
def test_check_resource_allowed_path_boundary_matching() -> None:
...
def test_check_resource_allowed_trailing_slash_handling() -> None:
...
def test_check_resource_allowed_case_insensitive_origin() -> None:
...
def test_check_resource_allowed_empty_paths() -> None:
