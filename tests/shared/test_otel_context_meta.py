...
async def test_no_span_in_context(patched_client: PatchedClient):
    ...
    assert patched_client.client_to_server_messages == snapshot(
        [
            JSONRPCRequest(jsonrpc="2.0", id=1, method="tools/call", params={"name": "my_tool"}),
                    ...
                    "tools": [
                        {
                            "name": "my_tool",
                            "description": "",
                            "inputSchema": {"properties": {}, "title": "my_toolArguments", "type": "object"},
                            "outputSchema": {
                        ...
                        {
                            "name": "tool_with_progress",
                            "description": "Send progress to the client, which should propagate _meta.",
                            "inputSchema": {"properties": {}, "title": "tool_with_progressArguments", "type": "object"},
                            "outputSchema": {
                                "properties": {"result": {"title": "Result", "type": "string"}},
                                "required": ["result"],
                                "title": "tool_with_progressOutput",
                                "type": "object",
                            },
                        },
                        {
                            "name": "tool_with_sampling",
                            "description": "Uses LLM sampling to call back to the client, which should propagate _meta.",
                            "inputSchema": {
                                "properties": {"topic": {"title": "Topic", "type": "string"}},
                                "required": ["topic"],
                                "title": "tool_with_samplingArguments",
                                "type": "object",
                            },
                            "outputSchema": {
                                "properties": {"result": {"title": "Result", "type": "string"}},
                                "required": ["result"],
                                "title": "tool_with_samplingOutput",
                                "type": "object",
                            },
                        },
                    ]
